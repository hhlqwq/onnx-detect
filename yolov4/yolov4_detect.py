...
def draw_bbox(image, bboxes,
              classes=read_class_names("yolov4/coco.names"),
              show_label=True):
    """
...
if __name__ == "__main__":
    ...
    original_image = cv2.imread("images/bus.jpeg")
    ...
    # shape of the preprocessed input
    print("Preprocessed image shape:", image_data.shape)

    sess = rt.InferenceSession("models/yolov4.onnx")
    ...
    cv2.imwrite("yolov4/out.jpg", image)
